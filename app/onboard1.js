...
const splash = require("../assets/Images/splash1.png");
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View>
        ...
        <View style={styles.info}>
          <CustomText isHeader size={vh(2.5)} text={"Make Sharing"} />
          <CustomText isHeader size={vh(2.5)} text={"Acessible Everywhere"} />
          <CustomText
            style={{ marginTop: 20 }}
            color={theme.colors.zinc_400}
            size={vh(1.8)}
            isHeader
            text={"Share Skills with one Another"}
          />
          <CustomText
            color={theme.colors.zinc_400}
            size={vh(1.8)}
        ...
        <View style={styles.pagination}>
          {[1, 2].map((num, index) => (
            <Pressable
              ...
              style={[styles.pagination_btn, num == 1 && styles.active]}
              key={index}
            />
          ))}
        </View>
